...
void push(int numero) {
    // Verificar se a pilha não está cheia e se o número é ímpar
    if (!verificarCheia() && numero % 2 != 0) {
        ...
        // Se estiver cheia ou o número for par, informa o usuário
        printf("\nNao eh possivel inserir, pilha cheia ou numero par.");
    }
}
